...
Un site web est un ensemble de [pages web](https://fr.wikipedia.org/wiki/Page_web) et de [ressources](https://fr.wikipedia.org/wiki/Ressource_du_World_Wide_Web) reliées par des [hyperliens](https://fr.wikipedia.org/wiki/Hyperlien), déﬁni et accessible par une [adresse web](https://fr.wikipedia.org/wiki/Uniform_Resource_Locator). Un site est développé à l'aide de langages de [programmation web](https://fr.wikipedia.org/wiki/Programmation_web), puis hébergé sur un [serveur web](https://fr.wikipedia.org/wiki/Serveur_web) accessible via le [réseau](https://fr.wikipedia.org/wiki/R%C3%A9seau_informatique) mondial [Internet](https://fr.wikipedia.org/wiki/Internet), un [intranet](https://fr.wikipedia.org/wiki/Intranet) local, ou n'importe quel autre réseau, tel que le [réseau Tor](https://fr.wikipedia.org/wiki/Tor_(r%C3%A9seau)). L'ensemble des sites web publics constituent le [World Wide Web](https://fr.wikipedia.org/wiki/World_Wide_Web).
{% endcitation %}
